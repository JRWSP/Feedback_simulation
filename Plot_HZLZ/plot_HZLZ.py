...
plt.plot(LZ100_ANA[0][:ter], LZ100_ANA[1][:ter], color=palette(2))
plt.scatter(x[:ter:50], LZ100[1][:ter:50], color=palette(2), s=s, label=r"$\tau = 0.1T_{\Omega}$")
plt.plot(LZ300_ANA[0][:ter], LZ300_ANA[1][:ter], color=palette(3), linewidth=w)
plt.scatter(x[:ter:50], LZ300[1][:ter:50], color=palette(3), s=s, label=r"$\tau = 0.3T_{\Omega}$")
plt.plot(LZ500_ANA[0][:ter], LZ500_ANA[1][:ter], color=palette(4), linewidth=w)
plt.scatter(x[:ter:50], LZ500[1][:ter:50], color=palette(4), s=s, label=r"$\tau = 0.5T_{\Omega}$")
plt.plot(x[:ter], LZ[0][:ter], '--', color=palette(0), label="Lindblad", linewidth=w)
plt.plot(x[:ter], Mx[:ter], '--', color=palette(1), label=r"$\tau = 0$")
