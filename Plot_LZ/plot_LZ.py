...
plt.plot(LZ100_ANA[0], LZ100_ANA[1], color=palette(0), linewidth=w)
plt.scatter(x[::50], avg[0][0][::50], color=palette(0), label=r"$\tau = 0.1T_{\gamma}$", s=s)
plt.plot(LZ300_ANA[0], LZ300_ANA[1], color=palette(1), linewidth=w)
plt.scatter(x[::50], avg[1][0][::50], color=palette(1), label=r"$\tau = 0.3T_{\gamma}$", s=s)
plt.plot(LZ500_ANA[0], LZ500_ANA[1], color=palette(2), linewidth=w)
plt.scatter(x[::50], avg[2][0][::50], color=palette(2), label=r"$\tau = 0.5T_{\gamma}$", s=s)
plt.plot(LZ[0], LZ[1], '--', color=palette(3), label=r"$Lindblad$", linewidth=w)
plt.plot(x, Sim0[0][0], '--', color=palette(4), label=r"$\tau = 0$")
